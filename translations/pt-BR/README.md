...
- [Protocolos de comunicação](#protocolos-de-comunicação)
  ...
  - [Como gRPC funciona?](#como-grpc-funciona)
  - [O que é um webhook?](#o-que-é-um-webhook)
  - [Como melhorar o desempenho de uma API?](#como-melhorar-o-desempenho-de-uma-api)
  - [HTTP 1.0 -\> HTTP 1.1 -\> HTTP 2.0 -\> HTTP 3.0 (QUIC)](#http-10---http-11---http-20---http-30-quic)
  - [SOAP vs REST vs GraphQL vs RPC](#soap-vs-rest-vs-graphql-vs-rpc)
  - [Código Primeiro vs. API Primeiro](#código-primeiro-vs-api-primeiro)
  - [Códigos de status HTTP](#códigos-de-status-http)
  - [O que um API gateway faz?](#o-que-um-api-gateway-faz)
  - [Como projetamos APIs efetivas e seguras?](#como-projetamos-apis-efetivas-e-seguras)
  - [Encapsulamento TCP/IP](#encapsulamento-tcpip)
  - [Por que o Nginx é chamado de proxy “reverso”?](#por-que-o-nginx-é-chamado-de-proxy-reverso)
...
### Como melhorar o desempenho de uma API?
...
### Código Primeiro vs. API Primeiro 
...
### Como projetamos APIs efetivas e seguras?
...
### Quais são os algoritmos comuns de balanceamento de carga?
...
### URL, URI, URN - Você conhece as diferenças? 
